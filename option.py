...
parser.add_argument("--pre_train", type=str, default=r"C:\Aakrit\College\8th Sem\Major Project\Image Inpainting\aotgan-streamlit\weights\G_latest.pt", help="path to pretrained models")
