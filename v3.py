...
if uploaded_file:
    ...
    # st.image(image, caption="Original Image (Resized for Display)", use_column_width=True)
    ...
    if st.button("Save Original Image with Mask and Binary Mask"):
        if canvas_result.image_data is not None:
            ...
            binary_mask_image.save("binary_mask.png")
            ...
            filename = r"E:\aotgan-streamlit\binary_mask.png"
            mask = cv2.resize(cv2.imread(filename, cv2.IMREAD_COLOR), (512, 512))
